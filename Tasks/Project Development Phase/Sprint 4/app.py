...
def index():
    if request.method == 'POST':
        ...
        API_KEY = "QrcU4BUNoQvSDl3qNLYJGdWRbdQb8ClLsXV3aCt5-mqe"
        ...
        response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/a13a3393-75f6-410d-af2f-f5fabd26fc91/predictions?version=2022-11-19', json=payload_scoring,
